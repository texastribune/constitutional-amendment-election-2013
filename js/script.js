...
var Result = Backbone.Model.extend({
    ...
    getRaceDescription: function() {
      var map = {
        'Prop 1': "Property tax exemption for surviving spouses of certain service members",
        'Prop 2': "Removing provisions for the State Medical Education Board",
        'Prop 3': "Allowing extension of exemption from inventory taxes for aircraft parts",
        'Prop 4': "Tax exemption for disabled veterans whose homesteads were donated by a charity",
        'Prop 5': "Authorizing a reverse mortgage loan for the purchase of homestead property",
        'Prop 6': "Creating funds to assist in the financing of priority projects in the state water plan",
        'Prop 7': "Allowing home-rule cities to decide how to fill vacant elected seats",
        'Prop 8': "Repealing the provision authorizing a hospital district in Hidalgo County",
        'Prop 9': "Expanding the State Commission on Judicial Conduct’s sanctioning authority"
      };
